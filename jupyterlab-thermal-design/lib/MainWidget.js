...
class ControlPanelWidget extends ReactWidget {
    ...
    render() {
        return (React.createElement(ControlPanel, { onExecute: async (scenarioId, params) => {
                try {
...
export class ThermalDesignWorkbench extends Widget {
    constructor(app) {
        ...
        controlPanel.processMessage(Widget.Msg.AfterAttach);
    }
}
//# sourceMappingURL=MainWidget.js.map