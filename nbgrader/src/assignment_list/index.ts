...
export class AssignmentListWidget extends Widget {
  ...
  constructor(app: JupyterFrontEnd) {
    ...
    var assignment_html = ([
      ...
      '      <span id="assignments_list_info" class="toolbar_info">此课程中已发布、已下载和已提交的作业：</span>',
      '      <div class="btn-group btn-group-xs">',
      '        <button type="button" class="btn btn-default" id="course_list_default">加载中，请稍候...</button>',
      ...
      '      <button id="refresh_assignments_list" title="刷新作业列表" class="btn btn-default btn-xs"><i class="fa fa-refresh"></i></button>',
      '      </span>',
      '    </div>',
      '  </div>',
